...
export default function Food(){
    ...
    return(
        ...
        <svg xmlns="http://www.w3.org/2000/svg" style={{"padding-bottom": "1rem"}} width="7rem" height= "7rem" viewBox="0 0 64 64">
            <g fill="#a6a8ab">
                ...
                <ellipse cx={39.822} cy={44.866} rx={23.808} ry={9.498}></ellipse>
            </g>
            <path fill="#d0d2d3" d="M32.677 51.11c-10.07 0-19.1-2.196-25.22-5.67c-.061.469-.098.943-.098 1.424c0 9.07 11.159 16.423 24.923 16.423c13.766 0 24.925-7.354 24.925-16.423q-.001-.518-.055-1.025c-6.091 3.241-14.804 5.271-24.477 5.271"></path>
            <path fill="#b6b6b7" d="M19.867 49.855c-4.805-.986-9.05-2.504-12.408-4.412c-.061.469-.098.943-.098 1.424c0 9.07 11.159 16.423 24.923 16.423c1.085 0 2.151-.052 3.202-.14c-8.358-2.168-14.506-7.216-15.619-13.295"></path>
            <path fill="#d0d2d3" d="M60.12 38.938c0 6.131-12.464 11.1-27.83 11.1c-15.371 0-27.832-4.976-27.832-11.1c0-6.133 12.461-11.11 27.832-11.11c15.366 0 27.83 4.973 27.83 11.11"></path>
            <ellipse cx={32.09} cy={38.508} fill="#a6a8ab" rx={23.809} ry={9.501}></ellipse>
            <g fill="#00a551">
